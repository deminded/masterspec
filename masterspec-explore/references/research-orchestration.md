...
| Уровень | Критерий | Фаза B |
|---------|----------|--------|
| **Малый** | <10 файлов ИЛИ <20k слов | **2** субагента (роли парами) |
| **Средний** | 10–50 файлов ИЛИ 20k–150k слов | **3** субагента |
| **Крупный** | >50 файлов ИЛИ >150k слов | **4** субагента (роль = агент) + дробление батчей по объёму |
